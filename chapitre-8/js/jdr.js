...
Joueur.decrire = function () {
    var description = this.nom + " a " + this.sante + " points de vie, " +
        ...
        this.inventaire.or + " pièces d'or et " + this.inventaire.cle +" clé(s)";
    return description;
};
...
Joueur.combattre = function (adversaire) {
    ...
    if (adversaire.sante === 0) {
        console.log(this.nom + " a tué " + adversaire.nom + " et gagne " +
            adversaire.valeur + " points d'expérience, ainsi que " + adversaire.inventaire.or +" pièces d'or et " + adversaire.inventaire.cle +" clé(s)");
